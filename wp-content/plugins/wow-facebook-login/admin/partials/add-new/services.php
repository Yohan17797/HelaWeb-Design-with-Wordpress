	...
	<div class="item-title">
		...
		<div class="wow-admin-col">
			<div class="wow-admin-col-12">
				<input type="checkbox" disabled> <label for="wow_mailchimp">MailChimp</label> <a href='admin.php?page=<?php echo $this->slug;?>&tab=pro' title="Only Pro version"><span class="dashicons dashicons-lock" style="color:#37c781;"></span></a>												
			</div>			
		</div>
