...
<div class="itembox">
	...
	<div class="wow-admin-col wow-wrap">
		<div class="wow-admin-col-12">
			<a href='admin.php?page=<?php echo $this->slug;?>&tab=pro' title="Only Pro version"><span class="dashicons dashicons-lock" style="color:#37c781;"></span></a> <input type="checkbox" disabled> <label for="wow_admin_email">Include email to admin</label> 															
		...
		<div class="wow-admin-col-12">
			<a href='admin.php?page=<?php echo $this->slug;?>&tab=pro' title="Only Pro version"><span class="dashicons dashicons-lock" style="color:#37c781;"></span></a> Admin Email: 												<br/>
	...
	<div class="wow-admin-col">
		<div class="wow-admin-col-12">			
			...
			<i>{profile} - Link to user profile </i><br/>
