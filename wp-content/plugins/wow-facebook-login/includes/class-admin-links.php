<?php if ( ! defined( 'ABSPATH' ) ) exit;
	/**
		...
		*
		* @package     Wow_Facebook_Login_ADMIN
		* @subpackage  
	...
	*/
	...
	class Wow_Facebook_Login_ADMIN_LINKS {
		...
		public function row_meta( $meta, $plugin_file ){
			...
			return $meta;
			$meta[] = '<a href="https://wow-estore.com/item/wow-facebook-login-pro/" target="_blank">Pro version</a> | <a href="https://www.facebook.com/wowaffect/" target="_blank">Join us on Facebook</a>';
			return $meta;
		}
