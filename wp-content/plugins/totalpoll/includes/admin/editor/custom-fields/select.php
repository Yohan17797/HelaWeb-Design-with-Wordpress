				...
				<div class="totalpoll-tab-content active" data-tp-tab-content="<?php echo $custom_field_id; ?>-basic">
					...
					<div class="settings-item">
						...
						<div class="settings-field">
							...
							<p class="feature-tip"><?php _e( 'Option per line.' ); ?></p>
					...
					<div class="settings-item">
						...
						<div class="settings-field">
							...
							<p class="feature-tip"><?php _e( 'Default value per line.' ); ?></p>
					...
					<div class="settings-item">
						...
						<div class="settings-field">
							...
							<label>
								<input type="checkbox" name="totalpoll[settings][fields][<?php echo $custom_field_index; ?>][extra][multiple]" <?php checked( empty( $custom_field['extra']['multiple'] ), false ); ?>>
