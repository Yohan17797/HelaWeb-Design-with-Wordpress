...
?>
<div class="totalpoll-tab-content settings-tab-content containables-container settings-custom-fields" data-tp-tab-content="custom-fields" data-tp-container>
	...
	<ul class="containables" data-tp-containables data-tp-sortable>
		<?php
		if ( ! empty( $fields ) ):
