	...
	<div class="settings-item-advanced <?php echo empty( $limitations['membership']['enabled'] ) ? '' : 'active'; ?>" data-tp-toggleable="limitations-membership-advanced">
		...
		<div class="settings-field">
			<label class="settings-field-label" for="totalpoll-settings-limitations-membership-type">
				...
				<span class="feature-details" title="<?php esc_attr_e( 'The membership type that can vote.', TP_TD ); ?>">?</span>
			</label>
			...
			<p class="feature-tip"><?php _e( 'Hold Control/Command for multiple selection.', TP_TD ); ?></p>
		</div>
	...
	<div class="settings-item-advanced <?php echo empty( $limitations['quota']['enabled'] ) ? '' : 'active'; ?>" data-tp-toggleable="limitations-quota-advanced">
		<div class="settings-field">
			<label class="settings-field-label">
				...
				<span class="feature-details" title="<?php esc_attr_e( 'The maximum number of votes that can be received in this poll.', TP_TD ); ?>">?</span>
			</label>
	...
	<div class="settings-item-advanced <?php echo empty( $limitations['date']['enabled'] ) ? '' : 'active'; ?>" data-tp-toggleable="limitations-date-advanced">
		<div class="settings-field">
			<label class="settings-field-label">
				...
				<span class="feature-details" title="<?php esc_attr_e( 'The date users will be able to vote.', TP_TD ); ?>">?</span>
			</label>
			<input type="text" data-tp-field-date name="totalpoll[settings][limitations][date][start]" min="0" step="1" class="settings-field-input widefat" value="<?php echo empty( $limitations['date']['start'] ) ? '' : esc_attr( date( 'm/d/Y H:i', $limitations['date']['start'] ) ); ?>">
		</div>

		<div class="settings-field">
			<label class="settings-field-label">
				<?php _e( 'End date', TP_TD ); ?>
				<span class="feature-details" title="<?php esc_attr_e( 'The date users won\'t be able to vote.', TP_TD ); ?>">?</span>
			</label>
			<input type="text" data-tp-field-date name="totalpoll[settings][limitations][date][end]" min="0" step="1" class="settings-field-input widefat" value="<?php echo empty( $limitations['date']['end'] ) ? '' : esc_attr( date( 'm/d/Y H:i', $limitations['date']['end'] ) ); ?>">
		</div>
