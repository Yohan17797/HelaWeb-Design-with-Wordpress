...
<div class="totalpoll-tab-content settings-tab-content settings-results" data-tp-tab-content="results">
	...
	<div class="settings-item">
		...
		<div class="settings-field">
			...
			<p class="feature-tip"><?php _e( 'Heads up! Enabling this along with pagination can cause performance issues.', TP_TD ); ?></p>
		</div>
	...
	<div class="settings-item-advanced <?php echo empty( $results['order']['enabled'] ) ? '' : 'active'; ?>" id="results-order-advanced" data-tp-toggleable="results-order-advanced">
		...
		<div class="settings-field">
			<label class="settings-field-label">
				...
				<span class="feature-details" title="<?php esc_attr_e( 'The results will be ordered by the following criteria.', TP_TD ); ?>">?</span>
			</label>
		...
		<div class="settings-field">
			<label class="settings-field-label">
				...
				<span class="feature-details" title="<?php esc_attr_e( 'The order direction (ascending or descending).', TP_TD ); ?>">?</span>
			</label>
	...
	<div class="settings-item-advanced <?php echo empty( $results['hide']['enabled'] ) ? '' : 'active'; ?>" id="results-order-advanced" data-tp-toggleable="results-hide-advanced">
		...
		<div class="settings-field">
			<label class="settings-field-label">
				...
				<span class="feature-details" title="<?php esc_attr_e( 'The results will be hidden until the following criteria are reached.', TP_TD ); ?>">?</span>
			</label>
		...
		<div class="settings-field">
			<label class="settings-field-label">
				...
				<span class="feature-details" title="<?php esc_attr_e( 'The following content will be shown instead of results.', TP_TD ); ?>">?</span>
			</label>
