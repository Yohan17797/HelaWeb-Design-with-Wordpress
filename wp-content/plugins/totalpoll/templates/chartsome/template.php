...
if ( ! class_exists( 'TP_Chartsome_Template' ) && class_exists( 'TP_Template' ) ):
	...
	class TP_Chartsome_Template extends TP_Template {
		...
		public function assets() {
			...
			wp_enqueue_script( 'google-chart', "https://www.google.com/jsapi?autoload={'modules':[{'name':'visualization','version':'1.1','packages':['corechart']}]}", array ( 'totalpoll' ), ( WP_DEBUG ? time() : TP_VERSION ) );
